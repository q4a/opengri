...
#var Preview = preload("res://addons/opengri/scenes/Preview.tscn")
#var IniEditor = preload("res://addons/opengri/scenes/IniEditor.tscn")
#var VanillaEditor = preload("res://addons/opengri/scenes/VanillaEditor.tscn")
#var CsvEditor = preload("res://addons/opengri/scenes/CsvEditor.tscn")
